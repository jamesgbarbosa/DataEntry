...
<html>
	...
	<body>
		<a href="#edit-beneficiary" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-beneficiary" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${beneficiaryInstance?.version}" />
				<fieldset class="form">
