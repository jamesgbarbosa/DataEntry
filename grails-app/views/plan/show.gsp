	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
                ...
                <li><g:link class="list" action="list">Search Plans</g:link></li>
			...
			<ol class="property-list plan">
				...
				<li class="fieldcontain">
					<span id="planHolder-label" class="property-label"><g:message code="plan.planHolder.label" default="Plan Holder" /></span>
						...
						<span class="property-value" aria-labelledby="planHolder-label"><g:link controller="client" action="show" id="${planInstance?.planHolder?.clientProfile?.id}">${planInstance?.planHolder?.clientProfile?.getFullName()}</g:link></span>
				...
				<li class="fieldcontain">
					<span id="agent-label" class="property-label"><g:message code="plan.agent.label" default="Agent" /></span>
						...
						<span class="property-value" aria-labelledby="agent-label"><g:link controller="client" action="show" id="${planInstance?.agent?.clientProfile?.id}">${planInstance?.agent?.clientProfile?.getFullName()}</g:link></span>
