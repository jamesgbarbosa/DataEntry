...
class SelectTagLib {
    ...
    void paymentMode = { attrs ->
        ...
        out << g.select(name: 'paymentMode', id: 'paymentMode' , from: PaymentMode.list(), optionKey: 'name', optionValue: 'name', value: attrs.value)

    }

    void planStatus = { attrs ->

        out << g.select(name: 'planStatus', id: 'planStatus' , from: PlanStatus.list(), optionKey: 'name', optionValue: 'name', value: attrs.value)

    }

    void designation = { attrs ->

        out << g.select(name: 'designation', id: 'designation' , from: Designation.list(), optionKey: 'name', optionValue: 'name', value: attrs.value)

    }

    void relationship = { attrs ->

        out << g.select(name: 'relationship', id: 'relationship' , from: Relationship.list(), optionKey: 'name', optionValue: 'name', value: attrs.value)
